    ...
    <main>
      <div className="contact-area d-flex align-items-center" style={{ backgroundColor: "var(--bg-color)" }}>
        <div className="contact-info" style={{ width: "100%", padding: "80px 5%" }}>
          <h2 style={{ color: 'var(--color-secondary)' }}>Sobre {brandConfig.name}</h2>
          <p>
        ...
        <div className="container">
          <div className="row">
            <div className="col-12 col-md-6 mb-4">
              <h4 style={{ color: 'var(--color-secondary)' }}>Nuestra Experiencia</h4>
              <p>
            ...
            <div className="col-12 col-md-6 mb-4">
              <h4 style={{ color: 'var(--color-secondary)' }}>Cobertura y Servicios</h4>
              <ul>
