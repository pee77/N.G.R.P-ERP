...
export default function ContactPage() {
  return (
    <main>
      <div className="contact-area d-flex align-items-center text-center justify-content-center">
        <div className="contact-info" style={{ maxWidth: "800px", padding: "100px 5%" }}>
          <h2 style={{ color: 'var(--color-secondary)' }}>Contacto Comercial</h2>
          <p>
            Comuníquese con el equipo de Proton Lab para cotizaciones, alianzas o información corporativa.
          </p>

          <div className="contact-address mt-50" style={{ display: "inline-block", textAlign: "left" }}>
            <p>
          ...
          <div className="row">
            <div className="col-12 col-lg-8">
              <div className="checkout_details_area clearfix">
                <div className="cart-page-heading mb-30">
                  <h5 style={{ color: 'var(--color-secondary)' }}>Enviar Mensaje</h5>
                </div>
            ...
            <div className="col-12 col-lg-4">
              <div className="checkout-content mt-50">
                <h5 className="title--" style={{ color: 'var(--color-secondary)' }}>Horario de Atención</h5>
