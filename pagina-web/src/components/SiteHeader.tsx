  ...
  return (
    <header className="header_area">
      <div className="classy-nav-container breakpoint-off d-flex align-items-center justify-content-between">
        ...
        <div className="header-meta d-flex clearfix justify-content-end" style={{ alignItems: 'center', gap: '15px' }}>
          ...
          <div className="user-login-info" style={{ display: 'flex', alignItems: 'center', padding: '0 10px' }}>
          ...
          <div className="cart-area header-cart-desktop" style={{ paddingLeft: '10px', paddingRight: '20px' }}>
