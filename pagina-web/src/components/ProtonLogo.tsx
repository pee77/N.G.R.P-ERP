export default function ProtonLogo({ className }: { className?: string }) {
  return (
    <div className={`${className}ml-5 proton-logo-container`} style={{ position: 'relative', width: '30%', maxWidth: '220px', height: '60px', display: 'flex', alignItems: 'center', justifyContent: 'center', transform: 'scale(0.8)' }}>
